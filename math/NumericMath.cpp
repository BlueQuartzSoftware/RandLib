 ...
 * @return
 */
double adaptiveSimpsonsAux(const std::function<double(double)>& funPtr, double a, double b, double epsilon, double S, double fa, double fb, double fc, int bottom)
{
...
bool findRootNewtonFirstOrder2d(const std::function<DoublePair(DoublePair)>& funPtr, const std::function<std::tuple<DoublePair, DoublePair>(DoublePair)>& gradPtr, DoublePair& root, long double funTol,
                                long double stepTol)
{
  /// Sanity check
