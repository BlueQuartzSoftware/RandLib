...
class RANDLIBSHARED_EXPORT NegativeBinomialDistribution
...
protected:
  enum GENERATOR_ID { TABLE, EXPONENTIAL, GAMMA_POISSON };
 ...
 */
template <typename IntType = int, typename T = double>
class RANDLIBSHARED_EXPORT NegativeBinomialRand
    : public NegativeBinomialDistribution<IntType, T> {
public:
  ...
  static constexpr char TOO_SMALL_VARIANCE[] =
      "Sample variance should be greater than sample mean";
