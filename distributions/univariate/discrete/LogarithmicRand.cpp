...
template <typename IntType> String LogarithmicRand<IntType>::Name() const {
...
template <typename IntType> IntType LogarithmicRand<IntType>::Variate() const {
...
template <typename IntType> long double LogarithmicRand<IntType>::Mean() const {
...
template <typename IntType> IntType LogarithmicRand<IntType>::Mode() const {
  return 1.0;
}
