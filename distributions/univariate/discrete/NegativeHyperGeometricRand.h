...
class RANDLIBSHARED_EXPORT NegativeHyperGeometricRand
...
public:
  NegativeHyperGeometricRand(IntType totalSize = 1,
                             IntType totalSuccessesNum = 1,
                             IntType limitSuccessesNum = 1);
  ...
  void SetParameters(IntType totalSize, IntType totalSuccessesNum,
                     IntType limitSuccessesNum);
