...
class RANDLIBSHARED_EXPORT BetaDistribution : public distributions::ContinuousDistribution<RealType>
{
protected:
 ...
 */
template <typename RealType = double>
class RANDLIBSHARED_EXPORT BetaRand : public BetaDistribution<RealType>, public ExponentialFamily<RealType, DoublePair>
{
public:
