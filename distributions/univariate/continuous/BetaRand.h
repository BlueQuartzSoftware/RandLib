...
class RANDLIBSHARED_EXPORT BetaDistribution
...
protected:
  BetaDistribution(double shape1 = 1, double shape2 = 1, double minValue = 0,
                   double maxValue = 1);
...
protected:
  ...
  static constexpr char ALPHA_ZERO[] =
      "Possibly one or more elements of the sample coincide with the lower "
      "boundary a.";
  static constexpr char BETA_ZERO[] =
      "Possibly one or more elements of the sample coincide with the upper "
      "boundary b.";
};
 ...
 */
template <typename RealType = double>
class RANDLIBSHARED_EXPORT BetaRand
    : public BetaDistribution<RealType>,
      public ExponentialFamily<RealType, DoublePair> {
public:
  BetaRand(double shape1 = 1, double shape2 = 1, double minValue = 0,
           double maxValue = 1)
   ...
   */
  void FitShapes(long double lnG, long double lnG1m, long double mean,
 ...
 */
template <typename RealType = double>
class RANDLIBSHARED_EXPORT BaldingNicholsRand
    : public BetaDistribution<RealType> {
  double F = 0.5, p = 0.5;
