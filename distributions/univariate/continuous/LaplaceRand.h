...
class RANDLIBSHARED_EXPORT AsymmetricLaplaceDistribution
    : public GeneralGeometricStableDistribution<RealType> {
public:
  AsymmetricLaplaceDistribution(double shift = 0, double scale = 1,
                                double asymmetry = 1);
 ...
 */
template <typename RealType = double>
class RANDLIBSHARED_EXPORT CenteredAsymmetricLaplaceRand
    : public AsymmetricLaplaceDistribution<RealType>,
 ...
 */
template <typename RealType = double>
class RANDLIBSHARED_EXPORT ShiftedAsymmetricLaplaceDistribution
    : public AsymmetricLaplaceDistribution<RealType> {
public:
  ShiftedAsymmetricLaplaceDistribution(double shift = 0, double scale = 1,
                                       double asymmetry = 1)
 ...
 */
template <typename RealType = double>
class RANDLIBSHARED_EXPORT AsymmetricLaplaceRand
    : public ShiftedAsymmetricLaplaceDistribution<RealType> {
public:
  AsymmetricLaplaceRand(double shift = 0, double scale = 1,
                        double asymmetry = 1)
      : ShiftedAsymmetricLaplaceDistribution<RealType>(shift, scale,
                                                       asymmetry) {}
  String Name() const override;
  void SetAsymmetry(double asymmetry);
  static RealType
  StandardVariate(double asymmetry,
 ...
 */
template <typename RealType = double>
class RANDLIBSHARED_EXPORT LaplaceRand
    : public ShiftedAsymmetricLaplaceDistribution<RealType> {
public:
