...
//  int j = startingPoint;
//  long double logBetaFun1 =
//      lgammaStartingPointpHalf + degreeCoef.lgammaHalfNu - degreeCoef.lgamma1;
//  long double logBetaFun2 =
//      lgammaStartingPointp1 + degreeCoef.lgammaHalfNu - degreeCoef.lgamma2;
//  long double I1 =
//      RandMath::ibeta(y, j + 0.5, degreeCoef.halfNu, logBetaFun1, logY, log1mY);
//  long double I2 =
//      RandMath::ibeta(y, j + 1.0, degreeCoef.halfNu, logBetaFun2, logY, log1mY);
//  long double lgammajpHalf = lgammaStartingPointpHalf,
//              lgammajp1 = lgammaStartingPointp1;
...
//    long double p =
//        temp - lgammaj; // p and q get by relation with previous values
//    p = std::exp(p);
...
//
//  // if (std::fabs(x) < 0.05)
//  // qDebug() << "SUM:" << x << (double)sum1 << (double)sum2 << (double)(0.5 *
//  // (sum1 + sum2));
...
//      lgammaStartingPointp1 + degreeCoef.lgammaHalfNu - degreeCoef.lgamma2;
//  long double I1 =
//      RandMath::ibeta(y, degreeCoef.halfNu, j + 0.5, logBetaFun1, logY, log1mY);
//  long double I2 =
//      RandMath::ibeta(y, degreeCoef.halfNu, j + 1.0, logBetaFun2, logY, log1mY);
//  long double lgammajpHalf = lgammaStartingPointpHalf,
//              lgammajp1 = lgammaStartingPointp1;
//  long double lgammaj1 = degreeCoef.lgamma1, lgammaj2 = degreeCoef.lgamma2;
//  long double I1Temp = I1, I2Temp = I2;
...
//  return PhimMu - cdfSeries(-x, nuCoefs, -mu);
//
//  /*double y = (x >= 0.0) ? PhimMu + cdfSeries(x, nuCoefs, mu) :
...
//  double root = 0;
//  RandMath::findMin([this](double x) { return -f(x); }, guess, root);
//  return root;
//}
//
...
//  double thirdMoment =
//      std::lgamma(0.5 * nu - 1.5); // TODO: use hashed GetLogGammaShapeRatio
...
//  return (thirdMoment - 3 * mean * var - std::pow(mean, 3)) /
