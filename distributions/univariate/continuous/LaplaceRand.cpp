...
{
  RealType X = (this->kappa == 1) ? LaplaceRand<RealType>::StandardVariate(this->localRandGenerator) : AsymmetricLaplaceRand<RealType>::StandardVariate(this->kappa, this->localRandGenerator);
