...
template <typename RealType> String CauchyRand<RealType>::Name() const {
  return "Cauchy(" + this->toStringWithPrecision(this->GetLocation()) + ", " +
...
template <typename RealType> RealType CauchyRand<RealType>::Variate() const {
...
template <typename RealType> long double CauchyRand<RealType>::Entropy() const {
