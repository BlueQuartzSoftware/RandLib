...
String CantorRand::Name() const { return "Cantor"; }
...
long double CantorRand::Mean() const { return 0.5; }
...
double CantorRand::Median() const { return 1.0 / 3; }

long double CantorRand::Skewness() const { return 0.0l; }

long double CantorRand::ExcessKurtosis() const { return -1.6l; }
